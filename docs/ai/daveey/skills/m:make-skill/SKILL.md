...
**Usage:** `/m:make-skill my:skill-name "Short description of what it does"`
...
- **Name**: `prefix:name` format (e.g., `gt:fix-ci`, `cf:really`, `t:run-tests`)
...
| ------ | ----------------------------- | -------------------- |
| `gt:`  | Graphite / PR workflow        | fix-ci, submit, cool |
| `cf:`  | Control flow / meta-execution | really               |
| `t:`   | Testing                       | run-tests            |
| `m:`   | Meta / skill management       | make-skill           |
| New?   | Ask user or infer from domain |                      |
