#!/usr/bin/env python3
"""
Generate richard_slides.pptx from docs/ai/richard sources plus figures in that folder.

Usage:
  python docs/ai/presentations/generate_richard_slides.py
...
PRESENT_DIR = Path(__file__).resolve().parent
RICHARD_DIR = PRESENT_DIR.parent / "richard"
MD_PATH = RICHARD_DIR / "richard.md"
CMD_PATH = RICHARD_DIR / "richard_commands.md"
IMG_DIR = RICHARD_DIR
OUT_PATH = PRESENT_DIR / "richard_slides.pptx"
