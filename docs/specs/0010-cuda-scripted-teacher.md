...
- Core logic: `cogames-agents/src/cogames_agents/policy/nim_agents/thinky_agents.nim`
- Python wrapper + short name `thinky`: `cogames-agents/src/cogames_agents/policy/nim_agents/agents.py`
