...
_HORDE_VARIANT_SPECS: dict[CogsGuardHordeVariant, dict[str, dict[str, object]]] = {
    "junctions": {
        "cogs_junction_now": _info_scalar("env_collective/cogs/aligned.junction"),
        "clips_junction_now": _info_scalar("env_collective/clips/aligned.junction"),
    },
    "vitals": {
    ...
    "economy_collective": {
        "team_carbon_now": _info_scalar("env_collective/cogs/carbon.amount"),
        "team_oxygen_now": _info_scalar("env_collective/cogs/oxygen.amount"),
        "team_germanium_now": _info_scalar("env_collective/cogs/germanium.amount"),
        "team_silicon_now": _info_scalar("env_collective/cogs/silicon.amount"),
        "team_heart_now": _info_scalar("env_collective/cogs/heart.amount"),
    },
    "tempo": {
    ...
    "junction_events": {
        "cogs_junction_gained": _info_scalar("env_collective/cogs/aligned.junction.gained"),
        "cogs_junction_lost": _info_scalar("env_collective/cogs/aligned.junction.lost"),
        "clips_junction_gained": _info_scalar("env_collective/clips/aligned.junction.gained"),
        "clips_junction_lost": _info_scalar("env_collective/clips/aligned.junction.lost"),
    ...
    "economy_flow": {
        ...
        "team_carbon_deposited": _info_scalar("env_collective/cogs/carbon.deposited"),
        "team_oxygen_deposited": _info_scalar("env_collective/cogs/oxygen.deposited"),
        "team_germanium_deposited": _info_scalar("env_collective/cogs/germanium.deposited"),
        "team_silicon_deposited": _info_scalar("env_collective/cogs/silicon.deposited"),
        "team_carbon_withdrawn": _info_scalar("env_collective/cogs/carbon.withdrawn"),
        "team_oxygen_withdrawn": _info_scalar("env_collective/cogs/oxygen.withdrawn"),
        "team_germanium_withdrawn": _info_scalar("env_collective/cogs/germanium.withdrawn"),
        "team_silicon_withdrawn": _info_scalar("env_collective/cogs/silicon.withdrawn"),
    },
    "action_counters": {
