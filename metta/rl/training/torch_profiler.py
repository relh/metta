...
# Large active window fallback so one schedule covers the full epoch while we step per minibatch.
...
class TorchProfileSession:
    ...
    def __enter__(self):
        ...
        active_steps = getattr(self._profiler_config, "active_steps", _PROFILE_ACTIVE_STEPS)
