"""Regression tests for game-version handling in tools/run.py."""
...
def test_run_tool_game_version_alias_env_override_regression(
...
def test_run_tool_game_version_short_hash_resolution_regression() -> None:
