...
def test_e2e_categorical_single_and_multi_suggestions() -> None:
    ...
    lr0: float = s0["policy_assets.learner0.optimizer.learning_rate"]
    ...
    observations: list[dict[str, Any]] = [
        {
            ...
            "suggestion": {"model.color": "green", "policy_assets.learner0.optimizer.learning_rate": 2e-4},
            "score": 0.5,
            "cost": 10.0,
        }
    ]
    ...
    for s in multi:
        ...
        lr: float = s["policy_assets.learner0.optimizer.learning_rate"]
        assert 1e-5 <= lr <= 1e-3
