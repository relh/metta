...
- Core evolution logic: `cogames-agents/src/cogames_agents/policy/evolution/cogsguard/evolution.py`.
- Coordinator and role selection:
  `cogames-agents/src/cogames_agents/policy/evolution/cogsguard/evolutionary_coordinator.py`.
...
- Behavior hooks are wired up for integration (see
  `cogames-agents/src/cogames_agents/policy/scripted_agent/cogsguard/behavior_hooks.py`): the coordinator can
