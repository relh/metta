---
name: cb.sync-nim-python
description:
  'Compare Nim and Python scripted agent implementations and align behavior. Use when asked to port or ensure parity
  between Nim and Python.'
---
