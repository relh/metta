...
| Submit       | `/pr.submit`                  | Push both branches           |
...
- **/pr.submit** - For submitting both branches after extraction

**Called by:**

- **/st.make-stack** - When independent features should be parallel, not stacked

**Pairs with:**

- **/st.make-stack** - For further splitting either branch into a sequential stack
- **/pr.cool** - Clean up after extraction
- **/pr.fix-branch** - Fix issues in extracted branches
