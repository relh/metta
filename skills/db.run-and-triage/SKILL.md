---
name: db.run-and-triage
description:
  'Execute provided command(s), capture failures, and summarize root cause and fixes. Use when asked to run a command
  and report errors.'
---
...
- For recipe runs, prefer `uv run ./tools/run.py <recipe>.<mode> <args...>`.
