---
name: tr.policy-save-load-audit
description:
  'Audit policy save/load and checkpoint handling across metta/cogames to find compatibility risks or legacy shims. Use
  when save/load behavior is in question.'
---
