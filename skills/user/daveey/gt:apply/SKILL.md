...
**Announce at start:** "I'm using the gt:apply skill to route changes to their correct branches."
...
# Stash everything
git stash push -m "gt:apply - routing changes"
...
# Stash changes
git stash push -m "gt:apply - for new branch"
...
- **/gt:extract** - For extracting features into new branches
- **/gt:fix-branch** - For fixing issues on specific branches
- **/gt:make-stack** - For creating new stack structure
