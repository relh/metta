...
| 7    | `/pr.submit`               | Test, clean, submit fix  |
...
- **wt.cleanup** - Worktree removal (Step 8)

**Called by:**

- **pr.fix-branch** - After /pr.fix-comments (worktree already set up)

**Pairs with:**

- **systematic-debugging** - For complex or unclear failures
- **pr.cool** - May introduce failures that need fixing
