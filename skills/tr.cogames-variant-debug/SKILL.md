---
name: tr.cogames-variant-debug
description:
  'Debug CoGames mission or variant regressions by comparing branch vs main. Use when behavior changes or a `cogames
  play` command regresses.'
---
