...
- name: OTEL_RESOURCE_ATTRIBUTES
  value: "deployment.environment={{ required "otel.env is required" .Values.otel.env }},service.version={{ .serviceVersion | default .Values.image.tag }}"
{{- end }}
{{- end }}
