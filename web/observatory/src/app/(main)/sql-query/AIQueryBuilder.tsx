...
export const AIQueryBuilder: FC<{
  ...
  return (
    <div className="mb-4 rounded-md border border-blue-200 dark:border-blue-800 bg-sky-50 dark:bg-sky-950 p-4">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="m-0 text-sm font-semibold uppercase tracking-wide text-blue-800 dark:text-blue-300">
          Describe your query
        </h3>
      </div>

      <textarea
        className="mb-3 min-h-[60px] w-full resize-y rounded border border-border-strong bg-surface text-foreground p-2.5 text-sm leading-normal focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/10"
        value={description}
