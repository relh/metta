...
def build_cogsguard_behavior_hooks(policy: CogsguardMultiRoleImpl) -> dict[str, BehaviorHook]:
    ...
    return {
        ...
        "discover_chargers": _discover_with_scout,
        "get_hearts": scrambler._get_hearts,
        "get_influence": _get_influence,
        "align_charger": aligner.execute_role,
        "scramble_charger": scrambler.execute_role,
        "find_enemy_charger": scrambler.execute_role,
    }
