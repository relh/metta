...
def make_query_config(query: TagQueryConfig) -> QueryConfigHolder: ...

class NegFilterConfig:
    def __init__(self) -> None: ...
    inner: list
    # set_* methods clear and set a single inner filter
    def set_inner_alignment_filter(self, filter: AlignmentFilterConfig) -> None: ...
    def set_inner_vibe_filter(self, filter: VibeFilterConfig) -> None: ...
    def set_inner_resource_filter(self, filter: ResourceFilterConfig) -> None: ...
    def set_inner_max_distance_filter(self, filter: MaxDistanceFilterConfig) -> None: ...
    def set_inner_game_value_filter(self, filter: GameValueFilterConfig) -> None: ...
    def set_inner_shared_tag_prefix_filter(self, filter: SharedTagPrefixFilterConfig) -> None: ...
    def set_inner_tag_prefix_filter(self, filter: TagPrefixFilterConfig) -> None: ...
    # add_* methods append inner filters (for multi-filter negation)
    def add_inner_alignment_filter(self, filter: AlignmentFilterConfig) -> None: ...
    def add_inner_vibe_filter(self, filter: VibeFilterConfig) -> None: ...
    def add_inner_resource_filter(self, filter: ResourceFilterConfig) -> None: ...
    def add_inner_max_distance_filter(self, filter: MaxDistanceFilterConfig) -> None: ...
    def add_inner_game_value_filter(self, filter: GameValueFilterConfig) -> None: ...
    def add_inner_shared_tag_prefix_filter(self, filter: SharedTagPrefixFilterConfig) -> None: ...
    def add_inner_tag_prefix_filter(self, filter: TagPrefixFilterConfig) -> None: ...
    def add_inner_neg_filter(self, filter: NegFilterConfig) -> None: ...
    def add_inner_or_filter(self, filter: "OrFilterConfig") -> None: ...
